...
- ## [cloakbrowser 免费指纹浏览器 _202608](https://www.nodeseek.com/post-880588-1)
- 目前来说免费中最好的一款产品。收费的话就是adspower
但是我认为cloakbrowser已经可以跟adspower不相上下。
虽然cloakbrower，只有免费一个。
但是别曲解免费一个的意思，意思是你开了A浏览器，不能同时开B，但是你关了A后，就可以开B。
意思是你可以创建无数个，但是不能同时打开2个窗口。
但是还有一种玩法，借用cloakbrower的框架
不使用cloakbrower的核心，转为自己本机电脑的Chrome原生核心。

虽然不能伪装各种不同的画像，类似于你开了无痕浏览器，但是这个无痕浏览器可以带有sock5代理
cookie，可以保存，每个其实也是独立的个体，只是借用了本机Chrome的内核。这种原生Chrome内核的指纹浏览器，测试了 亚马逊电商，基本上IP 代理没问题，自营产品秒下单。如果是其他冷门产品，当地手机当地网络都要验账单。

代理还可以自己增加xray内核，放vless等等协议。不单单只有socks5

- 指纹浏览器很多人都是习惯多开的，多个社媒账号，一开一关很影响效率的，不过很适合个人使用，不涉及外贸电商类的

- ## [还在用比特浏览器的 请注意 _202510](https://www.nodeseek.com/post-473198-1)
- 比特吃香非常难看, 之前用来多开, 就因为多登录了环境他就风控了, 要开套餐, 我开了一个最低配的一个月2美元以为就好了, 结果一个月后客服告诉我风控是永久的

- 本以为国内这些指纹浏览器屏蔽一些网站无法访问已经够了，没想到实名都搞出来了

- ## [最近指纹浏览器一个一个跳票，先是比特再到Anty _202509](https://www.nodeseek.com/post-455459-1)
- 所谓指纹就是把你的机型，显示器分辨率，安装的插件等等综合一下，自己改改应该也不是很麻烦，不过最好是有个列表对照着改
  - 用chromium 源码改的 很麻烦的 没那么简单
- 确实麻烦，但原理就是这个原理，在有限的权限空间里搜刮并整合你的个人信息，比如屏幕显示比例，系统语言之类的，所以说也并不一定就是一对一，比如你新买一批没用过的笔记本去测它们的浏览器指纹肯定全一样（不考虑ip这些，本来浏览器指纹就是为了替代对cookies和ip的风控）

- 之前坛友推荐的zibird这个月停止服务了。。。非常好用，还免费

- ## [推荐一下比特浏览器 _202603](https://www.nodeseek.com/post-667460-1)
- 最近在帮朋友的工作室做个小项目（注册账号）
注册这种最容易被识别设备和ip然后被风控禁止注册
这时候就不得不用指纹浏览器了，最开始认识到指纹浏览器这东西是在一年前，那时候也在做注册账号的项目；注册邮箱时随便注册几个就被禁止注册了，换ip也根本没用。（这样子根本没办法应对账号注册这种项目）当时也是在yt上面看到指纹浏览器这东西就下载了试试看。
使用后非常意外，效果远超预期了，只要我有大量不同的ip就不怕被关联被风控被禁止注册。
用过AdsPower Browser和比特浏览器，之前AdsPower Browser还好，免费用户起码给5个（好像是吧，有点忘了），现在好了，只给两个免费环境。
但是比特现在还是保持免费用户十个环境数 
比特还有个让我惊喜的免费功能，就是每次打开环境都是随机指纹，这个功能在AdsPower Browser是收费的，但是在比特是免费的

- ## [指纹浏览器技术难度很高吗？这么贵的服务，怎么不见有人卷一下？ - V2EX _202406](https://www.v2ex.com/t/1047208)
  - 10 个环境，一个月要 70 多块。100 个环境一个月要 200 块。最高能开到 1000 个环境，一个月 1000 多块。 这玩意边际成本很低把？用的人每个月都要付费，买卖似乎不错，没有程序员去卷一下吗？把价格打下来啊
- 把价格打下来了对程序员有什么好处？卷完了还挣不到钱

- 因为国内纯实名制啊，指纹有毛用，有实名制好使么
  - 指纹浏览器对于出海运营的企业很重要，因为涉及到例如亚马逊、推特以及脸书等等账号维护，而且通常指纹浏览器和代理 ip 利益关联绑定也很紧

- 我之前也提到卷 todo 不如卷这个，只不过这个基本 chrome 开源改，得会 c++把。应该还是得回点技术。之前远古编译过那个开源版本。

- 比起收益来说，100 个环境，200 块一个月，是真便宜。

- 做灰黑产的不差钱
- 使用群体不差钱压，黑产，外贸之类用的多

- 看看那些被打掉的黑灰产，别人是用几百台几千台物理机实现指纹，而不是用浏览器小打小闹
...
- 其实市场很卷了，AdsPower 做的最早，也最贵，我司一直在用，你说换家便宜的，之前养的号都在上面不说，重新去设置一遍对接一遍接口，都是成本。感觉市场已经慢慢稳定成型，除非你有一款不一样的特别吸引人的，能吸引用户能从现有平台换到你的平台。

- 紫鸟浏览器、AdsPower 、比特浏览器、云登浏览器、VMLogin 、候鸟浏览器

随便搜了一下就一大堆，这个还不够卷么，哈哈。

- 用虚拟机可以吗，虚拟机里开启的浏览器指纹会不一样吗

- 这行业已经很卷了，ziniao 有他们那儿的 ZF 背书。

- ## [开源免费的指纹浏览器哪些可以推荐？ _202608](https://www.nodeseek.com/post-891018-1)
  - 主要用于各个平台推广账号的自动化发布

- 这玩意开源的都是一坨，闭源的也是一坨，主要看平台愿不愿意穿透，愿意的话，你用什么指纹浏览器都鸟用没有。经典例子就是我这里的跨境电商产业园，一个公司的PayPal账号负余额了，直接穿透了指纹浏览器，其他所有的收款账号全部关联。

- 自动化推荐看 Camoufox 或 rebrowser。手动的开源客户端大多内核太老，不如白嫖 Hubstudio/AdsPower 的免费额度，或者直接干净家宽 + 原生 Chrome 独立目录，反而不容易被风控穿透。

- ## [CloakBrowser 号称能够通过所有机器人检测测试的隐形 Chromium - LINUX DO _202603](https://linux.do/t/topic/1758569/9)
- 关键的 c++ 补丁的部分没开源，开源的只是 python/js 的控制部分
  - 开源是不是就被告了

- 验证通过率的话 Camoufox 也很高，有头配合 opencv 可以过滑块
挑选开源指纹浏览器挑花眼
Camoufox 开发者住院导致维护落下，正式版还在 25 年 3 月 
站内佬友项目也有 GeekezBrowser 和 fingerprint-chromium
然后就是这个神秘的半开源项目，性能看上去不错，不知道 bug 多否、后门有否

- ## [指纹浏览器 CloakBrowser 好用吗? 有什么别的推荐的吗? - LINUX DO _202608](https://linux.do/t/topic/2715596)
  - CloakBrowser 听说要收费 这个好用吗？
- 让 agent 自己调用的，好不好用不清楚，但能用
